        ...
        switch (args[1].toLowerCase()) {
            ...
            if (args.length == 3) {
                ...
                for (Option option : options) {
                    if (option instanceof ContOption && option.getName().equalsIgnoreCase(args[2]))
                    contOption = (ContOption)option;

                }  if (contOption == null)
                return ChatUtil.print("Option not found");

                builder.append("Options for ").append(module.getName()).append("::").append(contOption.getName()).append(":");
            ...
            if (options.isEmpty())
            return ChatUtil.print("Module is empty");
            ...
            case "set":
            if (args.length < 4)
            return ChatUtil.print("Provide more arguments");
