...
public double getPositionZ() { return this.z; }
...
public boolean getRotating() { return this.rotating; }
    ...
    public static class C06PacketPlayerPosLook extends C03PacketPlayer {
        ...
        public C06PacketPlayerPosLook(double playerX, double playerY, double playerZ,
        float playerYaw, float playerPitch, boolean playerIsOnGround) {
            this.x = playerX;
