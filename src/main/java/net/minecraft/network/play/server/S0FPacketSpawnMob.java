...
public class S0FPacketSpawnMob implements Packet<INetHandlerPlayClient> {
    ...
    private int velocityY; private int velocityZ; private byte yaw; private byte pitch; private byte headPitch; private DataWatcher field_149043_l; private List<DataWatcher.WatchableObject> watcher;

    public Packets pType() {
        return Packets.S_SPAWN_MOB;
