...
public class S2APacketParticles implements Packet<INetHandlerPlayClient> {
    ...
    private float yOffset; private float zOffset; private float particleSpeed; private int particleCount; private boolean longDistance; private int[] particleArguments;

    public Packets pType() {
        return Packets.S_PARTICLES;
