...
public class S44PacketWorldBorder implements Packet<INetHandlerPlayClient> {
    ...
    private double targetSize; private double diameter; private long timeUntilTarget; private int warningTime; private int warningDistance;

    public Packets pType() {
        return Packets.S_WORLD_BORDER;
