...
public class S01PacketJoinGame implements Packet<INetHandlerPlayClient> {
    ...
    private EnumDifficulty difficulty; private int maxPlayers; private WorldType worldType; private boolean reducedDebugInfo;

    public Packets pType() {
        return Packets.S_JOIN_GAME;
