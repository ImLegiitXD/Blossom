...
public class S27PacketExplosion implements Packet<INetHandlerPlayClient> {
    ...
    private List<BlockPos> affectedBlockPositions; private float field_149152_f; private float field_149153_g; private float field_149159_h;

    public Packets pType() {
        return Packets.S_EXPLOSION;
