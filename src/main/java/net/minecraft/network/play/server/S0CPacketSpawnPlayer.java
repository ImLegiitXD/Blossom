...
public class S0CPacketSpawnPlayer implements Packet<INetHandlerPlayClient> {
    ...
    private byte yaw; private byte pitch; private int currentItem; private DataWatcher watcher; private List<DataWatcher.WatchableObject> field_148958_j;

    public Packets pType() {
        return Packets.S_SPAWN_PLAYER;
