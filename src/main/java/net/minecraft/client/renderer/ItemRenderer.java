    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null) {
                ...
                RenderItemEvent event = new RenderItemEvent(false, this.itemToRender.getItemUseAction());
                event.call();
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || event.isForceUse())
                {
                    EnumAction enumaction = event.getAction();
